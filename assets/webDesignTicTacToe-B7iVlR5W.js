...
}`,type:"js"})]}),e.jsx("br",{}),e.jsx("button",{onClick:()=>{n.current.showModal()},children:"View JS Code"})]})]}),e.jsx("div",{className:"BackCenter",children:e.jsx(d,{text:"Back",onClick:()=>{window.location.href="/ultimate-programming-guide/WebDesign/Projects/"}})})]}),e.jsx(l,{dialogRef:c,CodeType:"HTML",code:`<!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
